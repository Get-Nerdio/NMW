#description: Installs Microsoft Virtual Desktop Optimizations for Windows 10 1909 (clone and edit to customize)  
...
- Ensure this script is run for version 1909 
#>
...
[
    ...
    {
        "HivePath": "HKLM:\\DEFAULT\\Software\\Microsoft\\Windows\\CurrentVersion\\BackgroundAccessApplications\\Microsoft.PPIProjection_cw5n1h2txyewy",
        "KeyName": "Disabled",
        "PropertyType": "DWORD",
        "PropertyValue": 1,
        "SetProperty": "True"
...
mkdir "C:\Windows\temp\NMWLogs\ScriptedActions\win10optimize1909" -Force
Start-Transcript -Path "C:\Windows\temp\NMWLogs\ScriptedActions\win10optimize1909\ps_log.txt" -Append
...
mkdir C:\WVDTemp\Optimize_sa -force

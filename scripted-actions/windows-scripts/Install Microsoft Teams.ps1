...
Start-Transcript -Path "C:\Windows\temp\NMWLogs\ScriptedActions\msteams\install\ps_log.log" -Append
Write-Host "######################################
...
Start-Process C:\Windows\System32\msiexec.exe -ArgumentList  '/i C:\Windows\Temp\msteams_sa\install\Teams_windows_x64.msi /l*v C:\Windows\temp\NMWLogs\ScriptedActions\msteams\teams_install_log.txt ALLUSER=1 ALLUSERS=1 /qn /norestart' -wait
...
Start-Process C:\Windows\System32\msiexec.exe -ArgumentList '/i C:\Windows\Temp\msteams_sa\install\MsRdcWebRTCSvc_x64.msi /l*v C:\Windows\temp\NMWLogs\ScriptedActions\msteams\WebRTC_install_log.txt /qn /norestart' -Wait

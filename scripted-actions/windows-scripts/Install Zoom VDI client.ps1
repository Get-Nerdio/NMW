...
Please note: In order to use Zoom's redirection, you must install the 
plugin for the Zoom client used on the remote desktop client's machine.
The plugin can be found here: https://support.zoom.us/hc/en-us/articles/360052984292
under "Windows Virtual Desktop"
#>

# Configure powershell logging
mkdir "C:\Windows\System32\NMWLogs\ScriptedActions\zoom_sa" -Force
Start-Transcript -Path "C:\Windows\System32\NMWLogs\ScriptedActions\zoom_sa\ps_log.log" -Append
Write-Host "######################################
...
Start-Process C:\Windows\System32\msiexec.exe -ArgumentList "/i C:\Windows\Temp\zoom_sa\install\ZoomInstallerVDI.msi /l*v C:\Windows\System32\NMWLogs\ScriptedActions\zoom_sa\zoom_install_log.txt /qn /norestart"
